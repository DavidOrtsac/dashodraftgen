...
class ArticleGenerator:
    ...
    def setup(self):
        prompt_template_1 = PromptTemplate(
            input_variables=['content_type', 'brand', 'brand_description', 'platform', 'topic', 'target_audience','writing_style', 'additional_instructions'],
        ...
        prompt_template_2 = PromptTemplate(
            input_variables=['AI_analysis', 'content_type', 'brand', 'platform', 'target_audience', 'writing_style'],
        ...
        prompt_template_3 = PromptTemplate(
            input_variables=['first_draft', 'content_type', 'brand', 'topic', 'platform'],
            template="First Draft: {first_draft}\nMake a short and concise analysis of this first draft of a/an {content_type} for {brand}. Note that the topic of the {content_type} is {topic}. Target platform is {platform}. Follow this format for the analysis (append bullet points): \n 'DRAFT SUMMARY:' \n 'CRITICISM AND SUGGESTIONS ON HOW TO MAKE THE CONTENT MORE HUMANLIKE:' \n 'PLAN:' \nOutput:"
        )

        prompt_template_4 = PromptTemplate(
            input_variables=['AI_analysis_2', 'target_audience', 'content_type', 'brand', 'platform', 'first_draft'],
        ...
        self.sequential_chain = SequentialChain(
            ...
            input_variables=['content_type', 'brand', 'brand_description', 'platform', 'topic', 'writing_style', 'target_audience', 'additional_instructions'],
